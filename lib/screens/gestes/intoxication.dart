...
class IntoxicationPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _IntoxicationPageState();
}

class _IntoxicationPageState extends State<IntoxicationPage> {
